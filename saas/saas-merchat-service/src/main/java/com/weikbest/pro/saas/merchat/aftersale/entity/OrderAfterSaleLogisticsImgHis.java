...
@TableName("t_mmdm_order_after_sale_logistics_img_his")
@ApiModel(value = "OrderAfterSaleLogisticsImgHis对象", description = "订单售后物流图片拆分历史表")
public class OrderAfterSaleLogisticsImgHis implements Serializable {
