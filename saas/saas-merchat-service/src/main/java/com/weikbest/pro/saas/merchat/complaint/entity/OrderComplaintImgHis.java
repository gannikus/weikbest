...
@TableName("t_mmdm_order_complaint_img_his")
@ApiModel(value = "OrderComplaintImgHis对象", description = "订单投诉图片拆分历史表")
public class OrderComplaintImgHis implements Serializable {
