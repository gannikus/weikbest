 ...
 * @since :2022/10/15
 * <p>
 * 售后单商家拒绝收货后客户处理过期延时任务
 */
@Slf4j
@Component
public class OrderAfterSaleBusinessRejectDeliveryCustomerExecuteTimeoutDelayTaskProcess extends DelayTaskProcess {

    /**
     * 售后单延时队列前缀
     */
    public static final String TASK_PREFIX = RedisKey.DelayTask.DELAY_ORDER_AFTER_SALE_BUSINESS_REJECTDELIVERY_CUSTOMER_EXECUTETIMEOUT_KEY;
...
//    public static final Long TIME_OUT_7_DAY = 7 * 24 * 60 * 60 * 1000L;
    ...
    public OrderAfterSaleBusinessRejectDeliveryCustomerExecuteTimeoutDelayTaskProcess() {
    ...
    /**
     * @param taskId 任务ID = DELAY_ORDER_AFTER_SALE_BUSINESS_REJECTDELIVERY_CUSTOMER_EXECUTETIMEOUT:售后单ID:售后单状态
     */
    @Override
    public void doProcess(String taskId) {
        ...
        // 执行售后客户超时处理
        orderAfterSaleService.businessRejectDeliveryCustomerExecuteTimeout(id, afterSaleStatus);
    }


    @Override
    public String getName() {
        return "售后单商家拒绝收货后客户处理超时延时队列";
    }
