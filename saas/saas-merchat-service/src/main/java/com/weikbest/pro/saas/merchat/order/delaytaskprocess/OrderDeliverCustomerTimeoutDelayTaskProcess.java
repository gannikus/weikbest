 ...
 * @since :2022/10/17
 * <p>
 * 订单商家发货客户确认收货超时延时任务处理
 */
@Slf4j
@Component
public class OrderDeliverCustomerTimeoutDelayTaskProcess extends DelayTaskProcess {

    /**
     * 订单商家发货客户确认收货超时队列前缀
     */
    public static final String TASK_PREFIX = RedisKey.DelayTask.DELAY_ORDER_DELIVER_CUSTOMER_TIMEOUT_KEY;
...
//    public static final Long TIME_OUT_7_DAY = 7 * 24 * 60 * 60 * 1000L;
    ...
    public OrderDeliverCustomerTimeoutDelayTaskProcess() {
    ...
    public void putTask(Long id) {
        ...
        // 读取系统交易规则数据
        long timeout = dealService.findDeal().getAutoOrderReceive() * 24 * 60 * 60 * 1000L;
    ...
    /**
     * @param taskId 任务ID = RedisKey.DELAY_ORDER_DELIVER_CUSTOMER_TIMEOUT:订单ID
     */
    @Override
    public void doProcess(String taskId) {
        ...
        // 执行订单客户确认收货超时处理
        orderInfoService.deliverCustomerTimeoutExecute(id);
    }

    @Override
    public String getName() {
        return "订单商家发货客户确认收货超时延时队列";
    }
