...
@TableName("t_mmdm_order_after_sale_consult_record")
@ApiModel(value = "OrderAfterSaleConsultRecord对象", description = "订单售后协商历史记录表")
public class OrderAfterSaleConsultRecord implements Serializable {
    ...
    public static final String HISTORY_ORD = "history_ord";
    ...
    public static final String BACK_COURIER_IMG_PATH = "back_courier_img_path";
    ...
    public static final String SEND_COURIER_IMG_PATH = "send_courier_img_path";
    ...
    @ApiModelProperty("协商排序")
    @TableField("history_ord")
    ...
    @TableField(value = "change_type", insertStrategy = FieldStrategy.NOT_EMPTY)
