...
@Slf4j
@Component
public class OrderAfterSaleBusinessRejectApplyExecuteTimeoutDelayTaskProcess extends DelayTaskProcess {

    /**
     * 售后单延时队列前缀
     */
    public static final String TASK_PREFIX = RedisKey.DelayTask.DELAY_ORDER_AFTER_SALE_BUSINESS_EXECUTETIMEOUT_KEY;
...
//    public static final Long TIME_OUT_2_DAY = 2 * 24 * 60 * 60 * 1000L;
    ...
    public OrderAfterSaleBusinessRejectApplyExecuteTimeoutDelayTaskProcess() {
    ...
    public void putTask(Long id, String afterSaleStatus) {
        ...
        // 读取系统交易规则数据
        long timeout = dealService.findDeal().getRefundRepealTimeout() * 24 * 60 * 60 * 1000L;
    ...
    /**
     * @param taskId 任务ID = DELAY_ORDER_AFTER_SALE_BUSINESS_EXECUTETIMEOUT:售后单ID:售后单状态
     */
    @Override
    public void doProcess(String taskId) {
        ...
        // 执行售后商家超时处理
        orderAfterSaleService.businessExecuteTimeout(id, afterSaleStatus);
    }

    @Override
    public String getName() {
        return "售后单商家处理客户申请超时延时队列";
    }
}
