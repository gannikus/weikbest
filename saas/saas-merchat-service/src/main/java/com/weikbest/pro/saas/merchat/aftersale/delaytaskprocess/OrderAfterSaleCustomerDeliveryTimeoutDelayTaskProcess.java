 ...
 * @since :2022/10/15
 * <p>
 * 售后单商家同意后客户发货处理过期延时任务
 */
@Slf4j
@Component
public class OrderAfterSaleCustomerDeliveryTimeoutDelayTaskProcess extends DelayTaskProcess {

    /**
     * 售后单延时队列前缀
     */
    public static final String TASK_PREFIX = RedisKey.DelayTask.DELAY_ORDER_AFTER_SALE_CUSTOMER_DELIVERYTIMEOUT_KEY;
...
//    public static final Long TIME_OUT_7_DAY = 7 * 24 * 60 * 60 * 1000L;
    ...
    public OrderAfterSaleCustomerDeliveryTimeoutDelayTaskProcess() {
    ...
    /**
     * @param taskId 任务ID = DELAY_ORDER_AFTER_SALE_CUSTOMER_DELIVERYTIMEOUT:售后单ID:售后单状态
     */
    @Override
    public void doProcess(String taskId) {
        ...
        // 执行售后客户发货超时处理
        orderAfterSaleService.customerDeliveryTimeout(id, afterSaleStatus);
    }

    @Override
    public String getName() {
        return "售后单商家同意后客户发货处理超时延时队列";
    }
