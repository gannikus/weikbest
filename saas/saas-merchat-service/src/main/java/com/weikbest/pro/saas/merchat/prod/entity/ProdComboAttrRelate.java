...
@TableName("t_mmdm_prod_combo_attr_relate")
@ApiModel(value = "ProdComboAttrRelate对象", description = "商品销售套餐规格属性关联表")
public class ProdComboAttrRelate implements Serializable {
