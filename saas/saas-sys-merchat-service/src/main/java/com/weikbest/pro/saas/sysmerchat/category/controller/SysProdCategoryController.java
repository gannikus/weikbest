 ...
 */
@Slf4j
@Api(tags = {"category::平台商品分类表接口"})
@RestController
@RequestMapping("/sys/category/prod-category")
public class SysProdCategoryController {

    @Resource
    private ProdCategoryService prodCategoryService;

    @UseToken
    @SaveLog(value = "新增商品分类表数据")
    ...
    @UseToken
    @RemoveLog(value = "根据ID列表删除商品分类表数据")
