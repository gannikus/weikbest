...
public class AliyunOssServiceImpl implements AliyunOssService {
    ...
    protected AliyunOssServiceImpl() {
    }
     ...
     * @return
     */
    public static AliyunOssServiceImpl build(AliyunOssConfig aliyunOssConfig) {
        AliyunOssServiceImpl aliyunOssServiceImpl = new AliyunOssServiceImpl();
        aliyunOssServiceImpl.aliyunOssConfig = aliyunOssConfig;
        return aliyunOssServiceImpl;
    }
     ...
     * @return
     */
    public static AliyunOssServiceImpl build(String endPoint, String accessKeyId, String accessKeySecret, String bucketName) {
        AliyunOssServiceImpl aliyunOssServiceImpl = new AliyunOssServiceImpl();
        aliyunOssServiceImpl.aliyunOssConfig = new AliyunOssConfig(endPoint, accessKeyId, accessKeySecret, bucketName);
        return aliyunOssServiceImpl;
    }
