package com.weikbest.pro.saas.applet.complaint.module.vo;
...
@ApiModel(value = "AppOrderComplaintVO对象", description = "订单投诉表")
public class AppOrderComplaintVO implements Serializable {
    ...
    @ApiModelProperty("投诉状态1-发起投诉 100-商家同意和解 101-商家不同意和解 200-用户认可和解 201-用户不认可和解 209-用户撤销投诉")
    private String complaintStatus;

    @ApiModelProperty("客户联系电话")
    private String customerPhone;

    @ApiModelProperty("反馈原因（用户）")
    private String custReason;

    @ApiModelProperty("沟通内容（商户）")
